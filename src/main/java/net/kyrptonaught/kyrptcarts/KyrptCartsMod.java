...
public class KyrptCartsMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        MinecartItem minecartItem = new MinecartItem(KYRPT_CART_TYPE, (new Item.Settings()).maxCount(1).group(ItemGroup.TRANSPORTATION));
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "kyrptcart"), minecartItem);
    }
}